...
<%
		...
		PreparedStatement titlesQuery = connection.prepareStatement("SELECT * FROM admin ");
...
<title>Gestione Amministratorti</title>
...
<body>
   ...
   <table>
  	 <tr> 
   		...
   		<td> <a href="lsAdmin.jsp" style="font-weight: bold;">Gestione Amministratori</a></td>
 	 </tr>
	</table>
	...
	<p style = "font-weight: bold"> Aggiungi un Amministratore: </p>
	<p> Nome: <input type="text" name="nome" size="20">
	 	Username: <input type="text" name="username" size="20">
	 	Password: <input type="password" name="password" size="20">
	<input type="submit" name="tipo" value="Aggiungi Admin" > </p>
	</form> 
	...
	<% 
		...
		<tr>	
			...
			<td> <a href="elimina?admin=<%= results.getString("username") %>"> Elimina</a>  </td>
...
<% 
	...
	<p style="color:red;"> Amministratore: <%= request.getAttribute("del") %> eliminato ! </p>
...
<% 	}
	...
	<p style="color:red;"> Amministratore aggiunto ! </p>
